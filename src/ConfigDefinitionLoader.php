...
class ConfigDefinitionLoader
{
    /**
     * @param array $definition
     * @param DefinitionGroup|null $definitionGroup
     * @return DefinitionGroup
     */
    public function load(array $definition, DefinitionGroup $definitionGroup = null): DefinitionGroup
    {
     ...
     * @param array $types
     */
    protected function loadTypeHandlers(DefinitionGroup $definitionGroup, array $types)
    {
     ...
     */
    protected function loadCommands(DefinitionGroup $definitionGroup, array $commands)
    {
     ...
     * @param array $events
     */
    protected function loadEvents(DefinitionGroup $definitionGroup, array $events)
    {
     ...
     */
    protected function loadFieldDefaults(DefinitionGroup $definitionGroup, array $defaults)
    {
